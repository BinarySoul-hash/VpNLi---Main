...
def buy_hub_kb(trial_available: bool = False) -> InlineKeyboardMarkup:
    ...
    kb.row(InlineKeyboardButton(text="🛰️ Продлить существующую подписку", callback_data="buy_renew_list"))
    if trial_available:
        kb.row(InlineKeyboardButton(text="🎁 Получить 3 дня бесплатно", callback_data="trial"))
    kb.row(InlineKeyboardButton(text="🏠 В главное меню", callback_data="main_menu"))
    return kb.as_markup()
...
def confirm_payment_kb(
    ...
    *,
    ...
    kb = InlineKeyboardBuilder()
    kb.row(InlineKeyboardButton(text=f"💳 Перейти к оплате · {price} ₽", callback_data=f"pay_{devices}_{months}"))
    kb.row(InlineKeyboardButton(text="🎟 Ввести промокод", callback_data="enter_promo"))
    if has_active_promo:
        kb.row(InlineKeyboardButton(text="❌ Отменить промокод", callback_data="cancel_open_promo"))
    kb.row(InlineKeyboardButton(text="◀️ Назад", callback_data=back_callback))
    kb.row(InlineKeyboardButton(text="🏠 В главное меню", callback_data="main_menu"))
    return kb.as_markup()
...
def payment_link_kb(url: str, payment_id: int) -> InlineKeyboardMarkup:
    kb = InlineKeyboardBuilder()
    kb.row(InlineKeyboardButton(text="💳 Открыть оплату", url=url))
    kb.row(InlineKeyboardButton(text="✅ Я оплатил", callback_data=f"check_payment_{payment_id}"))
    kb.row(InlineKeyboardButton(text="✖️ Отменить платёж", callback_data=f"cancel_payment_{payment_id}"))
    return kb.as_markup()
...
def profile_kb(has_subs: bool = False) -> InlineKeyboardMarkup:
    kb = InlineKeyboardBuilder()
    if has_subs:
        kb.row(InlineKeyboardButton(text="🛒 Купить / продлить VPN", callback_data="buy"))
...
def subscription_detail_kb(sub_id: int, is_active: bool, is_expired: bool = False) -> InlineKeyboardMarkup:
    kb = InlineKeyboardBuilder()
    if is_active:
        kb.row(InlineKeyboardButton(text="🔗 Получить ссылку", callback_data=f"get_link_{sub_id}"))
        ...
        kb.row(InlineKeyboardButton(text="🛒 Купить новую подписку", callback_data="buy"))
        if is_expired:
...
def limit_reached_kb(sub_id: int) -> InlineKeyboardMarkup:
    kb = InlineKeyboardBuilder()
    kb.row(InlineKeyboardButton(text="🛰️ Управление ссылками", callback_data=f"manage_links_{sub_id}"))
...
def limit_violation_kb(sub_id: int) -> InlineKeyboardMarkup:
    kb = InlineKeyboardBuilder()
    kb.row(InlineKeyboardButton(text="🛰️ Продлить эту подписку", callback_data=f"renew_options_{sub_id}"))
...
def subs_list_kb(subs: list[dict]) -> InlineKeyboardMarkup:
    ...
    kb.row(InlineKeyboardButton(text="🛒 Купить / продлить", callback_data="buy"))
    kb.row(InlineKeyboardButton(text="🏠 В главное меню", callback_data="main_menu"))
    return kb.as_markup()
...
def renewal_options_kb(sub_id: int) -> InlineKeyboardMarkup:
    kb = InlineKeyboardBuilder()
    kb.row(InlineKeyboardButton(text="🛰️ Продлить текущий тариф", callback_data=f"renew_same_{sub_id}"))
...
def after_howto_platform_kb(sub_available: bool = False) -> InlineKeyboardMarkup:
    ...
    if sub_available:
        ...
        kb.row(InlineKeyboardButton(text="🛒 Купить подписку", callback_data="buy"))
...
def admin_menu_kb() -> InlineKeyboardMarkup:
    kb = InlineKeyboardBuilder()
    kb.row(InlineKeyboardButton(text="📊 Дашборд и метрики", callback_data="adm_stats"))
    kb.row(InlineKeyboardButton(text="📣 Рассылка пользователям", callback_data="adm_broadcast"))
    kb.row(InlineKeyboardButton(text="📣 Рассылка с кнопками", callback_data="adm_broadcast_kb"))
    kb.row(InlineKeyboardButton(text="🎟 Промокоды", callback_data="adm_promo_menu"))
    kb.row(InlineKeyboardButton(text="🔍 Поиск пользователя", callback_data="adm_find_user"))
    kb.row(InlineKeyboardButton(text="🏠 В главное меню", callback_data="main_menu"))
    return kb.as_markup()
...
def admin_back_kb() -> InlineKeyboardMarkup:
    kb = InlineKeyboardBuilder()
    kb.row(InlineKeyboardButton(text="◀️ В админ-панель", callback_data="adm_back"))
    kb.row(InlineKeyboardButton(text="🏠 В главное меню", callback_data="main_menu"))
    return kb.as_markup()
